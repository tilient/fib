...
lf[3]=C_decode_literal(C_heaptop,"\376B\000\000\0073f195ba");
lf[4]=C_h_intern(&lf[4],16,"\003sysbuild-branch");
lf[5]=C_h_intern(&lf[5],17,"\003sysbuild-version");
lf[6]=C_decode_literal(C_heaptop,"\376B\000\000\0054.9.0");
C_register_lf2(lf,7,create_ptable());
t2=C_mutate2((C_word*)lf[0]+1 /* (set! ##sys#build-tag ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_193,a[2]=((C_word)li0),tmp=(C_word)a,a+=3,tmp));
...
{"f_193:build_2dversion_2escm",(void*)f_193},
